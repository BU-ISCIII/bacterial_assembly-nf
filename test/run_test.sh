...
nf_cmd="nextflow -C ../nextflow.config run $script_path -resume -name \"$run_name\" --fasta ${data_dir}/genome.fa --gtf ${data_dir}/genes.gtf --reads \"${data_dir}/*.fastq.gz\" --outdir ./${data_path}/results"
